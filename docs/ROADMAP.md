...
**Phase**: **開発運用ルール移植（CMS方式）＋学習の待ち時間解消（learn-ahead）**（2026-07-07 完了・`3216177`・デプロイ＋実機確認済み）
**最終更新**: 2026-07-07
**次のタスク**: SRS総合評価レポートの残実装（練習モードの記録方式／速度→簡単判定の重み／同期の差分化／送信キュー消失対策）→ 各種しきい値の実データ調整 → 科目拡張（数学・理科デッキ）
