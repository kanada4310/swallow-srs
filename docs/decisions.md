...
- [20260828-instructor-key-teacher-gate](decisions/20260828-instructor-key-teacher-gate.md) `#reading` `#syntax` `#security` `#contracts` `#auth` _(Phase 読解アプリ)_ — 講師用の正解表を、講師だけが読める入口の向こうへ移す（本番反映済み 2026-08-28）
