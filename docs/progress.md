...
## 現在の作業
- Phase: **デザイン全面刷新「藍・空・喉の橙」✅＋チュートリアル第1弾✅＋生徒スマホ確認環境✅**（いずれも 2026-07-07・コミット/プッシュ済み・**要 Vercel デプロイ＋再ログイン**）
- 最終更新: 2026-07-07
- 次にやること:
  1. **Vercel デプロイ＋実機確認**: 生徒スマホ（LINE経由）で新デザイン・ミッションカード・コーチマーク。`scripts/device-preview.mjs` でも随時確認可
