...
### 11.2 生徒詳細ビュー（学習タイムライン）
講師が生徒をクリックすると、詳細な学習タイムラインを表示。

- [ ] 学習履歴タイムライン（いつ・何を・どれだけ）
- [ ] デッキ別の正答率・問題カード一覧
- [ ] 1on1面談用のデータ表示
...
**Phase**: Phase 9.1 デッキ一覧UX改善 ✅ 完了
**最終更新**: 2026-02-11
**次のタスク**: Phase 9.2 最近学習したデッキのクイックアクセス

### 次回セッションでやること

1. **Phase 9.2**: 最近学習したデッキのクイックアクセス
