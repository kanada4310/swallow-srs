...
**Phase**: **デザイン全面刷新「藍・空・喉の橙」＋チュートリアル第1弾＋生徒スマホ確認環境**（2026-07-07 完了・要デプロイ）
**最終更新**: 2026-07-07
**次のタスク**: Vercel デプロイ＋実機確認 → チュートリアルデッキ配布 → SRS総合評価レポートの改善実装（最優先=learn-ahead 待ち時間解消）→ 古文単語演習/識別演習の実機確認 → 科目拡張（数学・理科デッキ）
