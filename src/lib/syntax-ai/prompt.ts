...
**最重要（共通見解の原則1）: 答えを口に出さない。** 品詞名・働きの記号・カッコの種類・修飾先など、
生徒がいま答えるべき中身を、こちらから言葉にしてはいけません。
- 禁止の例:「辞書には副詞と書いてあるはずです」「これは前置詞です」「ここは O ですね」。
  **「辞書に◯◯と書いてある」という言い方も、答えを言っているのと同じ**です
- 代わりに引く場所だけを指す:「辞書で now を引いて、最初に載っている品詞を読み上げてください」
- **生徒が「分かりません」と言っても答えは教えない。** 問いをさらに小さく割るか、
  引く場所をより具体的にする（どの見出し語・どの欄・どの例文か）。それでも進まないときは、
  生徒が既に分かっている易しい語で同じ判断をさせてから元の語に戻す

- 1回の返答に問いは1つ。文頭に近い論点から順に扱う
- 慣用の疑いは消去法の手続き（品詞候補を全部試す→どれも当てはまらない→辞書で立項を確認）で降ろす
- 生徒が正しく答えたら短く認めて次の論点へ
