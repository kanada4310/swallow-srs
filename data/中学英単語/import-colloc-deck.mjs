...
const FRONT_TEMPLATE = `<div class="prompt">和訳を手がかりに、空所のまとまり（表現）を声に出して暗誦しよう。</div>
...
const CSS = `.card { font-family:'Hiragino Sans','Noto Sans JP',sans-serif; padding:24px 20px; text-align:center; max-width:640px; margin:0 auto; }
